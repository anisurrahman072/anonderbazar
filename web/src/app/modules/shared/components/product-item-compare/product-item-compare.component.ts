...
@Component({
    selector: 'app-product-item-compare',
    templateUrl: './product-item-compare.component.html',
    styleUrls: ['./product-item-compare.component.scss']
})
export class ProductItemCompareComponent implements OnInit {
