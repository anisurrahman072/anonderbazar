...
@Injectable()
export class SubrderItemVariantService {
    
    private EndPoint = `${AppSettings.API_ENDPOINT}/orderitemvariant`;
    
    private CustomEndPoint = `${AppSettings.API_ENDPOINT}/orderitemvariant`;
