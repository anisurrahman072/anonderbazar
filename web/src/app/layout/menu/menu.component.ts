...
export class MenuComponent implements OnInit {
  ...
  */
  ...
  navigateBySubCategory(event, category, subCategory){
      ...
      this.selectedCategoryId = category.id;
      this.router.navigate(['/products/category/', this.selectedCategoryId], {queryParams: {category: category.id,sub:subCategory.id}});
  }
  ...
  navigateBySubSubCategory(event, category, subCategory, subSubCategory){
      event.stopPropagation();
      this.selectedCategoryId = category.id;
      this.router.navigate(['/products/category/', this.selectedCategoryId], {queryParams: {category: category.id,sub:subCategory.id, subsub:subSubCategory.id}});
  }
  ...
  navigateByBrand(event, category, brand){
      event.stopPropagation();
      this.selectedCategoryId = category.id;
      this.router.navigate(['/products/category/', this.selectedCategoryId], {queryParams: {category: category.id,brand:brand.id}});
  }
