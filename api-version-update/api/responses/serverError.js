...
module.exports = function serverError (data, options) {
  ...
  if (data !== undefined) {
    sails.log.error(`RequestUrl: ${req.path} ###### `+'Sending 500 ("Server Error") response: \n',data);
  }
  else {sails.log.error(`RequestUrl: ${req.path} ###### `+'Sending empty 500 ("Server Error") response');}
  ...
  else {return res.view('500', { data: viewData, title: 'Server Error' }, (err, html) => {
