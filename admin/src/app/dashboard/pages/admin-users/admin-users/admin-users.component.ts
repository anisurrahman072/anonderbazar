...
export class AdminUsersComponent implements OnInit {
    ...
    /** Event method for deleting Admin Users */
    deleteConfirm(id) {
        if(id === 1) {
            this._notification.error('Stop!', 'Admin can not be deleted');
            return;
        }
    ...
    getPageData(event?: any, forExcel?: boolean) {
        ...
        this.adminUsersService.getAllAdminUsers(
            this.page,
    ...
    /** Modal for showing available users to download */
    showProductModal = () => {
